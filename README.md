...
فونتک یک کتابخانه فونت محلی برای Chrome است. می‌توانید چند فایل فونت اضافه کنید و برای هر سایت یا هر صفحه، فونت متفاوتی انتخاب کنید. تا وقتی آدرسی را خودتان به فهرست اضافه نکرده باشید، افزونه هیچ تغییری در آن ایجاد نمی‌کند.
